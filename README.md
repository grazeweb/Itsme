...
<title>ITSME • CubeCraft Queen</title>
...
<header>
  <div class="logo-area">
    ...
    <div>
      <h1 style="margin:0; font-size: 22px;">ITSME • CubeCraft Queen</h1>
...
<div class="main-grid">
      ...
      <div class="profile-content">
        <div style="display:flex; gap:30px; flex-wrap:wrap; align-items:flex-start;">
          ...
          <div style="flex:1;">
            ...
            <p style="margin:6px 0 16px 0; font-weight:700; opacity:0.8;" id="disp_tag">CubeCraft • Level 32</p>
            <div style="display:flex; gap:10px; flex-wrap:wrap;">
              ...
              <div class="pill" id="rank_pill" style="background: linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%); color:#78350f; border:2px solid #fcd34d; box-shadow:0 4px 12px rgba(251, 191, 36, 0.3);">Rank: <span id="disp_rank">▲ Gold</span></div>
            </div>
  ...
  <aside class="sidebar-section">
    ...
    <div class="bf-card">
      ...
      <p style="background:rgba(255,255,255,0.4); padding:12px; border-radius:12px; font-size:14px; font-weight:600; line-height:1.5; margin:0;" id="disp_msg">"Tum CubeCraft ki queen ho — main tumhara proud bf hoon."</p>
  ...
  <div class="modal-content">
    ...
    <div class="modal-body" id="loginView">
      <div style="text-align:center; padding:20px;">
        ...
        <input type="password" id="adminCodeInput" class="form-input" style="text-align:center; font-size:20px; letter-spacing:4px;" placeholder="••••••••">
    ...
    <div class="modal-body hidden" id="controlsView" style="max-height:70vh; overflow-y:auto;">
      ...
      <div style="background:#e0f2fe; padding:12px; border-radius:12px; margin-bottom:16px; font-weight:700; color:#0369a1; font-size:12px;">👤 BASIC INFO</div>
      ...
      <div class="input-group">
        ...
        <input type="text" id="edit_bio" class="form-input" placeholder="CubeCraft Queen 👑">
      </div>
      <div class="input-group">
        <label>Age</label>
      ...
      <div style="background:#dbeafe; padding:12px; border-radius:12px; margin:20px 0 16px 0; font-weight:700; color:#1e40af; font-size:12px;">🎮 MINECRAFT</div>
      <div class="input-group">
        <label>Edition</label>
      ...
      <div style="background:#f0fdf4; padding:12px; border-radius:12px; margin:20px 0 16px 0; font-weight:700; color:#166534; font-size:12px;">📊 GAME STATS</div>
      <div class="input-group">
      ...
      <div style="background:#fce7f3; padding:12px; border-radius:12px; margin:20px 0 16px 0; font-weight:700; color:#831843; font-size:12px;">❤️ PERSONALITY</div>
      <div class="input-group">
  ...
  <div class="modal-content" style="max-width:600px; max-height:80vh; overflow-y:auto;">
    ...
    <div class="modal-body">
      ...
      <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-bottom:20px;">
        ...
        <div><div style="font-size:11px; color:#64748b; font-weight:700; margin-bottom:4px;">BIO</div><div style="font-weight:600; font-size:14px;" id="stat_bio">CubeCraft Queen 👑</div></div>
...
const rankColors = {
  ...
  'Lapis': {color: '#06b6d4', text: '#0e7490', bg: 'linear-gradient(135deg, #06b6d4 0%, #0891b2 100%)', icon: '◆', shadow: 'rgba(6,182,212,0.3)'},
  'Gold': {color: '#fbbf24', text: '#78350f', bg: 'linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%)', icon: '▲', shadow: 'rgba(251,191,36,0.3)'},
  'Diamond': {color: '#3b82f6', text: '#1e40af', bg: 'linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)', icon: '◇', shadow: 'rgba(59,130,246,0.3)'},
  'Emerald': {color: '#a855f7', text: '#6b21a8', bg: 'linear-gradient(135deg, #a855f7 0%, #9333ea 100%)', icon: '✦', shadow: 'rgba(168,85,247,0.3)'},
  'Obsidian': {color: '#1e3a8a', text: '#0c1e3e', bg: 'linear-gradient(135deg, #1e3a8a 0%, #1e1b4b 100%)', icon: '✦', shadow: 'rgba(30,58,138,0.3)'}
};
...
const defaultProfile = {
  ...
  msg: "Tum CubeCraft ki queen ho — main tumhara proud bf hoon."
};
